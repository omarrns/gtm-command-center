...
// Section 8 of the ICP review. List of every artifact the orchestrator
// drew from. The user can audit how each exemplar mapped to the
// synthesized rubric. Per-artifact bodies are inline-expandable so a
// long page doesn't load until clicked.
//
            ...
            >
              ...
              >
                <div className="flex items-center gap-2">
                  <Icon size={14} className="text-[var(--color-text-subtle)]" />
