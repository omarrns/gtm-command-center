...
export default async function TodayPage() {
  ...
  // GTM users always redirect to their ICP dashboard hub.
  ...
  if (!skipOnboarding) {
    ...
    if (!onboarding.complete) {
      redirect(userType === "gtm" ? "/gtm/icp" : "/onboard");
    }
  }

  // GTM users live at /gtm/icp — both onboarding and post-onboarding dashboard.
  if (userType === "gtm") {
    redirect("/gtm/icp");
  }
