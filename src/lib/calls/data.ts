...
export const MOCK_CALLS: SalesCall[] = [
  {
    id: "1",
    title: "Churn risk: latency spikes on serverless — Notion",
    duration: "40m",
    rep: "Sam Torres",
    account: "Notion",
    stage: "Renewal",
...
Customer: I need to see numbers before we talk renewal.`,
  ...
  {
    id: "2",
    title: "Churn risk: no per-workspace cost attribution — Grafana Labs",
    duration: "44m",
    rep: "Marty Kausas",
...
Customer: The numbers need to be attributable, not just totals. This is a billing requirement.`,
  ...
  {
    id: "3",
    title: "Closed Won: Migration from OpenAI — Vercel",
    duration: "35m",
    rep: "Jordan Mills",
    account: "Vercel",
    stage: "Closed Won",
...
Customer: Three use cases come to mind. Let me validate the first before we talk expansion.`,
  ...
  {
    id: "5",
    title: "Technical eval: OpenAI vs Fireworks — Shopify",
    duration: "60m",
    rep: "Riley Park",
    account: "Shopify",
...
Customer: If function calling matches OpenAI reliability on our schemas, this is yours. That's the honest answer.`,
  ...
  {
    id: "6",
    title: "Technical eval: Replicate vs Fireworks fine-tuning — Hightouch",
    duration: "55m",
    rep: "Marty Kausas",
    account: "Hightouch",
    stage: "Technical Evaluation",
...
Customer: Do that. And what LoRA rank do you support? What's training time on a 7B model?`,
  ...
  {
    id: "7",
    title: "Demo: OpenAI cost reduction — Intercom",
    duration: "46m",
    rep: "Sam Torres",
    account: "Intercom",
    stage: "Demo",
...
Customer: I need to get our CTO bought in first. Can you help me build that case?`,
  ...
  {
    id: "8",
    title: "Demo: Fine-tuning for HR content — Lattice",
    duration: "48m",
    rep: "Marty Kausas",
    account: "Lattice",
    stage: "Demo",
